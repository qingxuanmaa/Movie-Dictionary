...
const MoviesList = ({
    ...
    // use Callback to define functions which 
    // should only be created once and will be dependencies for useEffect
        ...
        <div className="App">
            <Container className="main-container">
                            ...
                            <Col key={movie._id}>
                                ...
                                <Card.Img
                                    ...
                                    onError={(e) => {
                                        ...
                                        e.currentTarget.src="/images/NoPosterAvailable.jpeg";
                                    }}/>    
                                    <Card.Body>
                ...
                <Button
                    ...
                    >
                        Get next { entriesPerPage } result
                    </Button>
            </Container>
        </div>
    )
